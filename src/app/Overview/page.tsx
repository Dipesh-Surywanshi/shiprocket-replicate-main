...
import NdrDashboard from '../Ajay/page';
import Link from 'next/link';
import MainPage from '../Ajay/components/MainPage';
...
const Page = () => {
    return (
        <div>
            ...
            <div className='mx-5'>
            <div className="flex w-full mt-2 bg-[#ff0000b2]  px-2 py-2 shadow-md  md:p-3 rounded-2xl ">
            ...
            <div className='flex md:gap-x-5 gap-2 flex-col md:flex-row mt-4'>
                <Card data={data[0]} />
                <Maincard />
            </div>
                        ...
                        <div className='flex gap-3'>
                            <div className="group">
                                ...
                                <ul className="absolute hidden text-gray-700 pt-1 group-hover:block">
                                    ...
                                    <li className="">
                                        <a className="bg-gray-200 hover:bg-blue-500 hover:text-white py-2 px-4 block whitespace-no-wrap" href="#">Orders</a>
                                    </li>
                                </ul>
                            </div>
                            <BiSolidMessageRoundedError />
